...
class NormalUser(HttpUser):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.headers = {
            ...
            "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MjU5OTY3MDgsInVzZXJuYW1lIjoiYWRtaW4ifQ.v4ZcYEMKHlWEV4u6wUnFafsYVsJY_Cut6jMpVKPUVF4"
        }
        self.profile_ids = []
